...
def get_info_file_name(robot_name, robot_type=""):
    ...
    try:
        # Extract info_file_name from ocs2_g1_controller parameters
        info_file_name = config.get('ocs2_g1_controller', {}).get('ros__parameters', {}).get('info_file_name', 'task')
...
def launch_setup(context, *args, **kwargs):
    ...
    if ros2_controllers_path is None:
        ...
        ros2_control_node = Node(
            ...
            output="screen",
            condition=UnlessCondition(str(False)),
        )
...
def generate_launch_description():
    ...
    robot_name_arg = DeclareLaunchArgument(
        ...
        description="Robot name (unitree_g1 etc.)"
    )
