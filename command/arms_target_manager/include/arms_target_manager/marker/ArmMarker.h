...
namespace arms_ros2_control::command
{
    ...
    public:
        ...
        /**
         * @brief 使用最近一次 current_pose 重新刷新 marker pose（仅可视化，不 publish target）
         * @return true 刷新成功，false 表示没有可用的 current_pose
         */
    ...
    private:
        ...
        geometry_msgs::msg::PoseStamped latest_current_pose_;
